...
class Classes_order extends CI_Controller {
	public function __construct(){
		parent::__construct();
		$this->global_model->init(); 
		$this->post = $this->input->post(NULL,TRUE);
		$this->get = $this->input->get(NULL,TRUE);
		$this->data["controller_addr"]  = "classes_order";
		$this->databace = "classes_order";
	...
	public function index()
	{
		...
		$this->data["rs"] = $this->order_model->get_c_rs();
	...
	public function edit($id=0)
	{
		...
		$this->data["row"] = $this->order_model->get_c_row($id);
		$this->data['content_view'] = $this->load->view('admin/order/classes_edit_view',$this->data,true);
		$this->load->view('admin/master_view',$this->data);
	}
	...
	public function save($id=0)
	{
		...
		$bid = $this->global_model->sql_save("classes_order",$table,$where);
		echo "alert('儲存完成!');";
		echo "location='".ADMIN_URL."classes_order/edit/".$bid."';";
	}
