...
class Global_model extends CI_Model {
    public function __construct(){
        ...
        $_SESSION['active_path'] = array(0=>"login",1=>"accounts",2=>"index_product");
    }
    ...
    public function chech_active($active = array()){
        if(@$_SESSION[ADMIN_ACTIVE]=="0"||!isset($_SESSION[ADMIN_ACTIVE])){
            header("location:".ADMIN_URL.$_SESSION['active_path'][0]);exit;
            ob_end_flush();
        }else{
    ...
    public function active_goto(){
        header("location:".ADMIN_URL.$_SESSION['active_path'][$_SESSION[ADMIN_ACTIVE]]);exit;
        ob_end_flush();
    }
    ...
    public function checklogin()
    {
        if($_SESSION[ADMIN_ACTIVE]=="0"||!isset($_SESSION[ADMIN_ACTIVE]))
        {
            header("location:".SITE_URL."admin/login");exit;
            ob_end_flush();
        }
    }
