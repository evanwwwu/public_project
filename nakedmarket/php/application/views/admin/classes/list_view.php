...
<div class="right">
    <a class="pure-button notice" href="<?php echo ADMIN_URL.$controller_addr; ?>/edit">新增</a>
</div>
<table class="pure-table pure-table-bordered" width="100%">
    ...
    <tbody class="ui-sortable">
        ...
        <tr id="row_<?PHP echo $row["id"]?>">
            ...
            <td><?php echo $month_name[($row["month"]-1)] ?></td>
            ...
            <td>
                ...
                <a class="pure-button" title="刪除" onclick="list_view.del('<?PHP echo $row['id']?>','<?PHP echo ADMIN_URL.$this->data["controller_addr"];?>/del')"><i class="icon-trash"></i></a>
            </td>
        </tr>
        <?PHP endforeach;?>
    </tbody>
