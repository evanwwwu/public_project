    ...
    <tbody class="ui-sortable">
        ...
        <tr id="row_<?PHP echo $row["id"]?>">
            ...
            <td>
                ...
                <a class="pure-button" title="刪除" onclick="list_view.del2('<?PHP echo $row['id']?>','<?php echo $row["product_id"] ?>','<?PHP echo ADMIN_URL.$this->data["controller_addr"];?>/del')"><i class="icon-trash"></i></a>
            </td>
        </tr>
        <?PHP endforeach;?>
    </tbody>
