    ...
    <div id="viewport">
        ...
        <div id="wrapper">
            ...
            <div class="navigation">
                <?PHP if (isset($yymm)):?>
                <a href="<?PHP echo SITE_URL?>ajax/calendar_page_by_date/2/<?PHP echo $yymm;?>"></a>
                <?PHP else:?>
                <a href="<?PHP echo SITE_URL?>ajax/calendar_page/2/<?PHP echo $tag_id;?>"></a>
                <?PHP endif;?>
            </div>
        </div>
    </div>
...
<?PHP echo $login_view;?>
    ...
    <script>
        ...
        $(function(){
            if ($('.post_list ul li').length>0){
                $('.post_list ul').infinitescroll({
                    ...
                    donetext     : "" ,
                    bufferPx     : 40,
                    path:function(){return "<?PHP echo SITE_URL?>/ajax/calendar_page/"+page+"/<?PHP echo $tag_id;?>/?exist_banner="+ad+""}
                });
            }
        ...
        function search_month(){
            ...
            location = "<?PHP echo SITE_URL?>calendar/month/" + str_date;
        }
    </script>
</body>
</html>
