...
<body class="index">
    ...
    <div id="viewport">
        ...
        <div id="wrapper">
            ...
            <div class="navigation">
                ...
                <a href="<?PHP echo SITE_URL?>ajax/brand_page_by_letter/2/<?PHP echo $letter_selected;?>"></a>
                <?PHP else:?>
                <a href="<?PHP echo SITE_URL?>ajax/brand_page/2/"></a>
                <?PHP endif;?>
            </div>
        </div>
    </div>
    ...
    <?PHP if (isset($letter_selected) && $letter_selected!=''):?>
    var url = "<?PHP echo SITE_URL?>ajax/brand_page_by_letter/"+page+"/<?PHP echo $letter_selected;?>";
    <?PHP else:?>
    var url = "<?PHP echo SITE_URL?>ajax/brand_page/"+page+"";
    <?PHP endif;?>
    $(function(){
        if ($('.post_list ul li').length>0){
            $('.post_list ul').infinitescroll({
                loading: {
                    ...
                    <?PHP if (isset($letter_selected) && $letter_selected!=''):?>
                    url = "<?PHP echo SITE_URL?>ajax/brand_page_by_letter/"+page+"/<?PHP echo $letter_selected;?>";
                    <?PHP else:?>
                    url = "<?PHP echo SITE_URL?>ajax/brand_page/"+page+"";
                    <?PHP endif;?>
