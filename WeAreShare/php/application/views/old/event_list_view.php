...
<body class="index">
    ...
    <div id="viewport">
        ...
        <div id="wrapper">
            ...
            <div class="navigation">
                <?PHP if (isset($yymm)):?>
                <a href="<?PHP echo SITE_URL?>ajax/event_page_by_date/2/<?PHP echo $yymm;?>"></a>
                <?PHP else:?>
                <a href="<?PHP echo SITE_URL?>ajax/event_page/2/<?PHP echo $tag_id;?>"></a>
                <?PHP endif;?>
            </div>
        </div>
    </div>
    ...
    <?PHP if (isset($yymm)):?>
    var url="<?PHP echo SITE_URL?>ajax/event_page_by_date/"+page+"/<?PHP echo $yymm;?>";
    <?PHP else:?>
    var url="<?PHP echo SITE_URL?>ajax/event_page/"+page+"/<?PHP echo $tag_id;?>"
    <?PHP endif;?>
        ...
        if ($('.post_list ul li').length>0){
            $('.post_list ul').infinitescroll({
                loading: {
                    ...
                    page++;
                    <?PHP if (isset($yymm)):?>
                    url="<?PHP echo SITE_URL?>ajax/event_page_by_date/"+page+"/<?PHP echo $yymm;?>";
                    <?PHP else:?>
                    url="<?PHP echo SITE_URL?>ajax/event_page/"+page+"/<?PHP echo $tag_id;?>"
                    <?PHP endif;?>
...
function search_month(){
    ...
    location = "<?PHP echo SITE_URL?>event/month/" + str_date;
}
</script>
</body>
</html>
