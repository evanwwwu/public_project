        ...
        <div id="wrapper">
            ...
            <div class="innerWrapper">
				<div class="col-lg-8 col-xs-12">
					<div class="row">
						<div class="videoWrapper">
							<?=$VideoDetial->Video_Iframe?>
						</div>
					</div>
					<div class="col-lg-12 col-xs-12">
						<p><strong><?=$VideoDetial->Video_Name?></strong></p>
					</div>
					<div class="col-lg-12 col-xs-12">
						<p><?=$VideoDetial->Video_Content?></p>
					</div>
				</div>
				<div class="col-lg-4 col-xs-12">
					...
					<div class="col-lg-12 col-xs-12">
						<div class="video-pop-img">
							<div class="row"><img alt="<?=$val->Video_Name?>" src="<?PHP echo SITE_URL?>/images/video/<?=$val->Video_Id?>/<?=$val->Video_Picture?>"></div>
						</div>
						<div class="video-pop-name"><p><?=$val->Video_Name?></p></div>
					</div>
					<?}?>
				</div>
                <div class="clear"></div>
