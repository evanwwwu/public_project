...
<body class="index">
    ...
    <div id="viewport">
        ...
        <div id="wrapper">
            ...
            ?>
            <div class="innerWrapper video-innerWrapper">
            	<div class="video-box">
...
<?PHP echo $login_view;?>
    ...
    <script>
		...
		$(window).bind("scroll",function() {
		    ...
		    if (lock==false&&$(document).scrollTop() + $(window).height() > $(document).height() - 400) {  
		          //我这里偷个懒，没有写ajax的调用，直接触发了链接的click事件。  
		         $.ajax({
							type: "POST",
							dataType: 'json',
							url: "<?PHP echo SITE_URL?>video/ajax_video",
							data:{
								"page":page,
							...
							beforeSend:function(){
					  		...
					  		success: function(bakmsg){
					  			if(bakmsg.count > 0)
						  		{
					  				$(".video-box").append(bakmsg.data); 
					  				page=page+12;
					  				lock=false;
						  		}
						  		else
