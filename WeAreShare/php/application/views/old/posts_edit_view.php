     ...
     <form id="frm" class="pure-form pure-form-stacked">
      ...
      <fieldset>
       ...
       <div style="">
        ...
        <div style="display:inline-block;"><a href="<?PHP echo SITE_URL?>article/<?PHP echo $data['post_name']?>?preview=1" target="_blank" class="pure-button pure-button-primary">預覽</a></div>
        <div style="display:inline-block;"><a href="<?PHP echo ADMIN_URL?>posts/images/<?PHP echo $data['ID']?>" class="pure-button pure-button-primary">編輯照片</a></div>
        <div style="display:inline-block;"><a title="DELETE" class="pure-button error" onclick="del(<?PHP echo $data['ID']?>)" >DELETE</a></div>
        <div style="display:inline-block;"><a href="<?PHP echo ADMIN_URL?>posts" class="pure-button">BACK</a></div>
        </div>
...
$(function () {
    ...
    $('#frm').ajaxForm({
        ...
        url: '<?PHP echo ADMIN_URL?>posts/save',
        type: 'post',
        dataType: 'script'
    });
...
function del(id){
  ...
  $.post('<?PHP echo ADMIN_URL?>posts/del/0','id='+id,function(){
    location = '<?PHP echo ADMIN_URL?>posts';
  },'script');
}
</script>
</body>
