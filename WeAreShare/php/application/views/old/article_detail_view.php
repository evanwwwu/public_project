            ...
            <div class="innerWrapper">
                <div class="articles">
                    ...
                    <div class="fotorama" data-nav="thumbs" data-loop="true" data-allow-full-screen="true" data-width="100%" data-maxwidth="600" data-height="500" data-fit="contain">
                        ...
                        <img src="<?PHP echo IMG_URL . 'upload/' . $row['post_title'];?>" data-caption="<?PHP echo $row['caption'];?>"  data-full="<?PHP echo IMG_URL . 'upload/' . str_replace('_thumb','',$row['post_title']);?>">
                        <?PHP endforeach;?>
                    </div>
                    ...
                    <div class="pager">
                        ...
                        <a href="<?PHP echo SITE_URL . 'article/' . $data['prev_title']['post_name']?>" class="prevEvent" title="<?PHP echo $data['prev_title']['post_title']?>"><img src="<?PHP echo SITE_URL?>assets/old/images/transparent.gif"><span>上一則</span>
                            <p>
                        ...
                        <a href="<?PHP echo SITE_URL . 'article/' . $data['next_title']['post_name']?>" class="nextEvent" title="<?PHP echo $data['next_title']['post_title']?>"><img src="<?PHP echo SITE_URL?>assets/old/images/transparent.gif"><span>下一則</span>
                            <p>
                    ...
                    <div class="goTop"><a href="#">
                        <img src="<?PHP echo SITE_URL?>assets/old/images/transparent.gif">Top</a></div>
                    </div>
                    <!-- disqus -->
