...
<body class="index">
    ...
    <div id="viewport">
                            ...
                            <div id="related_article" class="tab_content" style="display: block;">
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <div class="info">
                                            <a href="<?PHP echo SITE_URL . 'article/' . $row['post_name']?>"><h2><?PHP echo $row['post_title']?></h2></a>
                                            <div class="date"><span></span><?PHP echo $row['display_date']?> | <?PHP echo $row['author'];?></div>
                                            <?PHP echo $row['brief']?>
                                        </div>
                                    </li>
                                    <?PHP endforeach;?>
        ...
        $(function(){
            site.changeFontSize();site.getFamous("<?PHP echo SITE_URL?>people/recommend/<?PHP echo ($data['post_name'])?>");
        })
        </script>
    </body>
    </html>
