...
<body class="index">
    ...
    <div id="viewport">
            ...
            <div class="innerWrapper">
                <div class="articles">
                    ...
                    <div class="pager">
                        ...
                        <a href="<?PHP echo SITE_URL . 'calendar/' . $data['prev_title']['post_name']?>" class="prevEvent" title="<?PHP echo $data['prev_title']['post_title']?>"><img src="<?PHP echo SITE_URL?>assets/old/images/transparent.gif"><span>上一則</span>
                            <p>
                        ...
                        <a href="<?PHP echo SITE_URL . 'calendar/' . $data['next_title']['post_name']?>" class="nextEvent" title="<?PHP echo $data['next_title']['post_title']?>"><img src="<?PHP echo SITE_URL?>assets/old/images/transparent.gif"><span>下一則</span>
                            <p>
        ...
        $(function(){
            site.changeFontSize();site.getRecommend("<?PHP echo SITE_URL?>calendar/recommend/<?PHP echo ($data['post_name'])?>");
        })
        </script>
    </body>
    </html>
