...
<body class="index">
    ...
    <div id="viewport">
        ...
        <div id="wrapper">
            ...
            <div class="innerWrapper">
                <div class="articles">
                    ...
                    <div class="fotorama" data-nav="thumbs" data-allow-full-screen="true" data-width="100%" data-maxwidth="600" data-height="500" data-fit="contain" data-loop="true">
                    ...
                    <div class="edit" style="text-align: right;">
                        <a style="color: #3b8bba;" href="<?PHP echo ADMIN_URL . 'gallery/edit/' .$data['ID']?>" target="_blank">編輯頁面</a>  
                    </div>
                    <?PHP endif;?>         
                    ...
                    <div class="pager">
                        ...
                        <a href="<?PHP echo SITE_URL . 'gallery/' . $data['prev_title']['post_name']?>" class="prevEvent" title="<?PHP echo $data['prev_title']['post_title']?>"><img src="<?PHP echo SITE_URL?>assets/old/images/transparent.gif"><span>上一則</span>
                            <p>
                        ...
                        <a href="<?PHP echo SITE_URL . 'gallery/' . $data['next_title']['post_name']?>" class="nextEvent" title="<?PHP echo $data['next_title']['post_title']?>"><img src="<?PHP echo SITE_URL?>assets/old/images/transparent.gif"><span>下一則</span>
                            <p>
        ...
        $(function(){
            site.changeFontSize();site.getRecommend("<?PHP echo SITE_URL?>gallery/recommend/<?PHP echo ($data['post_name'])?>");
        })
        </script>
    </body>
    </html>
