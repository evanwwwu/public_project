...
<body class="index">
    ...
    <div id="viewport">
        ...
        <div id="wrapper">
                ...
                <div class="brand index">
                    <div class="post_list">
                        <ul>
                            ...
                            <?PHP else:?>
                            <?PHP if ($data['post_type']=='brand'):?>
                            <li>
                                <div class="img">
                                    <a href="<?PHP echo SITE_URL . 'brand/' . $data['post_name']?>"><img src="<?PHP echo SITE_URL . 'upload/' . $data['cover_img']?>" border="0" width="190"></a>
                                </div>
                                <div class="content">
                                    <!-- <span class="categories"><?PHP echo $data['tags'];?></span> -->
                                    <h2><a href="<?PHP echo SITE_URL . 'brand/' . $data['post_name']?>"><?PHP echo $data['post_title'];?></a></h2>
                                    <div class="post-info">
                                    ...
                                    <a href="<?PHP echo SITE_URL . 'brand/' . $data['post_name']?>" class="readMore">閱讀全文 »</a>
                                </div>
                                <div class="clear">
                                </div>
                            </li>
            ...
            <div class="navigation">
                <?PHP if (isset($letter_selected) && $letter_selected!=''):?>
                <a href="<?PHP echo SITE_URL?>ajax/society_page_by_letter/2/<?PHP echo $letter_selected;?>"></a>
                <?PHP else:?>
                <a href="<?PHP echo SITE_URL?>ajax/society_page/2"></a>
                <?PHP endif;?>
            </div>
        </div>
    </div>
    ...
    <?PHP if (isset($letter_selected) && $letter_selected!=''):?>
    var url = "<?PHP echo SITE_URL?>ajax/society_page_by_letter/"+page+"/<?PHP echo $letter_selected;?>";
    <?PHP else:?>
    var url ="<?PHP echo SITE_URL?>ajax/society_page/"+page+"";
    <?PHP endif;?>
    $(function(){
        if ($('.post_list ul li').length>0){
            $('.post_list ul').infinitescroll({
                loading: {
                    ...
                    <?PHP if (isset($letter_selected) && $letter_selected!=''):?>
                    url = "<?PHP echo SITE_URL?>ajax/society_page_by_letter/"+page+"/<?PHP echo $letter_selected;?>";
                    <?PHP else:?>
                    url ="<?PHP echo SITE_URL?>ajax/society_page/"+page+"";
                    <?PHP endif;?>
...
$('.selectItem select').bind('change',function(){
    ...
    location = '<?PHP echo SITE_URL?>brand/letter/' + $(this).find('option:selected').text();
})
})
</script>
</body>
