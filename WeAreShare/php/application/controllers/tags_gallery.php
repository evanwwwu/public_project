...
class Tags_gallery extends CI_Controller {
	public function __construct(){
		parent::__construct();
		$this->load->model('tags_gallery_model','model');
	...
	public function index(){
		$this->check_login();
		$data['page_title'] = 'GALLERY類別 - ' . SITE_TITLE_ADMIN;
		$data['menu_selected'] = 'tags_gallery';
		...
		$this->load->view('tags_gallery_view',$data);
	}
