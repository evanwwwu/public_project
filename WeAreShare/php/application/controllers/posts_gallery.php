...
class Posts_gallery extends CI_Controller {
	public function __construct(){
		parent::__construct();
		$this->load->model('posts_gallery_model','model');
		$this->load->model('users_model');
		$this->load->model('tags_gallery_model');
	...
	public function index(){
		$this->check_login();
		$data['page_title'] = 'GALLERY - ' . SITE_TITLE_ADMIN;
		$data['menu_selected'] = 'posts_gallery';
		...
		$this->load->view('posts_gallery_view',$data);
	}

	public function edit($id=0){
		$this->load->model('users_model');
		$this->check_login();
		$data['page_title'] = 'GALLERY編輯 - ' . SITE_TITLE_ADMIN;
		$data['menu_selected'] = 'posts_gallery';
		$data['header'] = $this->load->view('header_view',$data,TRUE);
		$data['footer'] = $this->load->view('footer_view',NULL,TRUE);
		$data['menu'] = $this->load->view('menu_view',$data,TRUE);
		...
		$this->load->view('posts_gallery_edit_view',$data);
	}
