(function() {
    ...
    function openMenu() {
        ...
        // page.style.webkitTransform = 'translate3d(210px, 0 , 0)';
    ...
    function openLog() {
        ...
        // addClass(body, 'log-opening');

        // page.addEventListener(transitionEnd, function() {
        //     menuOpen = true;
        //     menuOpening = false;

        //     addClass(body, 'log-open');
        //     removeClass(body, 'log-opening');
        //     removeClass(body, 'log-moving');
    ...
    function closeLog() {
        ...
        // addClass(body, 'log-closing');

        // page.addEventListener(transitionEnd, function() {
        //     menuOpen = false;
        //     menuClosing = false;

        //     removeClass(body, 'log-open');
        //     removeClass(body, 'log-closing');
        //     removeClass(body, 'log-moving');
