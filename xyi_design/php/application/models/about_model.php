...
class About_model extends CI_Model {
    ...
    public function row(){
        $result = array();
            $sql = "SELECT  {$this->left_top} as left_top, {$this->mid_bottom} as mid_bottom, {$this->left_bottom} as left_bottom, {$this->right_bottom} as right_bottom, cover_img FROM about WHERE aboutid='1'";
