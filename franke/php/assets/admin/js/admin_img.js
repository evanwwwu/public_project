        ...
        return this.each(function(idx) {
            ...
            var set_gallery_img = function(img_val) {
                var gallery_ele = $('<div class="gallery_img"></div>'),
                    ...
                    post_ele = $('<input type="hidden" name="'+main_class + idx + '[]" value="' + img_val + '">');
            ...
            var main = $(this),
                upload_input = $('<input name="'+main_class+'_file' + idx + '" maxlength="5" type="file" multiple placeholder="" class="gallery_file' + idx + ' pure-input">'),
            ...
            upload_input.fileupload({
                ...
                url: _settings.upload_url + main_class+'_file' + idx,
                sequentialUploads: true,
                dataType: 'json',
                done: function(e, data) {
                    console.log(data);
